...
let rec cmdtable_data : (string*cmd_spec) list =
  [
    ...
    "usb-introduce",
    {
      reqd=["vm-uuid";"hostbus";"hostaddr";"sn";];
      optn=[ ];
      help="Create a USB." ;
      implementation=No_fd Cli_operations.USB.introduce;
      flags=[];
    };
    "usb-destroy",
    {
      ...
      optn=[];
      help="Destroy a USB.";
      implementation=No_fd Cli_operations.USB.destroy;
      flags=[];
    };
    "usb-attach",
    {
      reqd=["uuid"];
      optn=[];
      help="Attach new usb device into the vm.";
      implementation=No_fd Cli_operations.USB.attach;
      flags=[];
    };
    "usb-detach",
    {
      reqd=["uuid"];
      optn=[];
      help="Detach usb device from vm.";
      implementation=No_fd Cli_operations.USB.detach;
      flags=[];
    };
